...
- Synchronization to `/workspace/repo` negotiates typed V2 immutable-candidate activation with attested servers; older servers remain on the compatible V1 route.
