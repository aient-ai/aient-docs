...
Current invited-preview release: `0.10.0`
...
The commands documented in this section are the surface shipped in Aient CLI 0.10.0.
...
- If workspace layout certification is in progress, execution returns an actionable “workspace layout is temporarily busy” response without dispatching or replaying the command.
