...
description: "A compact index of the Aient CLI 0.10.2 commands and global flags."
---

# CLI command reference

This page indexes the commands shipped in Aient CLI 0.10.2. Use `aient COMMAND --help` for the flags supported by your installed version. Customer MCP management was merged after this release; see [Customer MCP connections](/ai-tools/customer-mcp-connections) for its next-release command family and the currently available UI, API, and MCP surfaces.
