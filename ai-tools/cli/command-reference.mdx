...
description: "A compact index of the Aient CLI 0.8.2 commands and global flags."
---

# CLI command reference

This page indexes the commands shipped in Aient CLI 0.8.2. Use `aient COMMAND --help` for the flags supported by your installed version.
