...
description: "A compact index of the Aient CLI 0.7.0 commands and global flags."
---
...
`aient agent` appears in top-level help as a reserved Slice 2 command group, but it has no functional agent subcommands in 0.7.0.
