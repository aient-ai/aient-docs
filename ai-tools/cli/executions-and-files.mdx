...
File commands address an existing unbound/operator sandbox and an explicit path. They are separate from exact Git workspace synchronization. In 0.7.0, they cannot carry the selectors required to address an environment-bound customer sandbox.
