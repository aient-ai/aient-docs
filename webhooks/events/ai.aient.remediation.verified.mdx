...
description: "CloudEvent fired when an Aient remediation is verified against telemetry, with payload fields problemId, remediationId, and verificationId for closure."
---

# ai.aient.remediation.verified

> Generated from `@aient/events`. Do not edit this page by hand.

A remediation was verified.
...
| Subject | `problems/{problemId}/verifications/{verificationId}` |
| Schema ID | `sch_01KXWFVE6ZFM1KD0HSB6AC4DMH` |
| Immutable schema | `https://registry.aient.ai/schemas/sch_01KXWFVE6ZFM1KD0HSB6AC4DMH.json` |
| Version alias | `https://registry.aient.ai/events/ai.aient.remediation.verified/v1.json` |
...
| `remediationId` | no | `string` | - |
| `rootExecutionId` | no | `string` | - |
| `verificationId` | no | `string` | - |
