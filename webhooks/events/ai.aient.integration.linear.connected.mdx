---
title: "integration.linear.connected"
description: "CloudEvent fired when a Linear workspace connection becomes usable, with payload fields for organisationId, workspaceId, and workspaceName."
---

# ai.aient.integration.linear.connected

> Generated from `@aient/events`. Do not edit this page by hand.

A Linear workspace connection became usable.
...
| Subject | `integrations/linear/{workspaceId}` |
| Schema ID | `sch_01J8X7AKZP4N6QHF2T1Y3R5V98` |
| Immutable schema | `https://registry.aient.ai/schemas/sch_01J8X7AKZP4N6QHF2T1Y3R5V98.json` |
| Version alias | `https://registry.aient.ai/events/ai.aient.integration.linear.connected/v1.json` |
...
```json
{
  ...
  "dataschema": "https://registry.aient.ai/schemas/sch_01J8X7AKZP4N6QHF2T1Y3R5V98.json",
  "id": "evt_01J8X7AKZP4N6QHF2T1Y3R5VAA",
  "organisationid": "11111111-1111-4111-8111-111111111111",
  "source": "https://aient.ai/api/organisations/11111111-1111-4111-8111-111111111111",
  "specversion": "1.0",
  "subject": "integrations/linear/workspace_example",
  "time": "2026-04-25T12:00:00.000Z",
  "type": "ai.aient.integration.linear.connected"
}
```
