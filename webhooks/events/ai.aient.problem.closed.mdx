...
description: "CloudEvent fired when an Aient problem is closed, with payload fields organisationId, problemId, and closureReason for tracking lifecycle outcomes."
---

# ai.aient.problem.closed

> Generated from `@aient/events`. Do not edit this page by hand.

A problem was closed.
...
| Schema ID | `sch_01J8X7AKZP4N6QHF2T1Y3R5VA3` |
| Immutable schema | `https://registry.aient.ai/schemas/sch_01J8X7AKZP4N6QHF2T1Y3R5VA3.json` |
| Version alias | `https://registry.aient.ai/events/ai.aient.problem.closed/v1.json` |

## Payload Fields

| Field | Required | Type | Enum |
| --- | --- | --- | --- |
| `closureReason` | yes | `string` | - |
...
{
  "data": {
    "closureReason": "example",
    "organisationId": "11111111-1111-4111-8111-111111111111",
    "problemId": "problem_example"
  },
  "datacontenttype": "application/json",
  "dataschema": "https://registry.aient.ai/schemas/sch_01J8X7AKZP4N6QHF2T1Y3R5VA3.json",
