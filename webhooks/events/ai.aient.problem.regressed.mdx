---
title: "problem.regressed"
description: "CloudEvent fired when a previously closed Aient problem regresses, with payload fields organisationId, problemId, and previousStatus for routing."
---

# ai.aient.problem.regressed

> Generated from `@aient/events`. Do not edit this page by hand.

A previously closed problem regressed.
...
| Schema ID | `sch_01J8X7AKZP4N6QHF2T1Y3R5VA4` |
| Immutable schema | `https://registry.aient.ai/schemas/sch_01J8X7AKZP4N6QHF2T1Y3R5VA4.json` |
| Version alias | `https://registry.aient.ai/events/ai.aient.problem.regressed/v1.json` |
...
```json
{
  ...
  "dataschema": "https://registry.aient.ai/schemas/sch_01J8X7AKZP4N6QHF2T1Y3R5VA4.json",
  ...
  "type": "ai.aient.problem.regressed"
}
```
