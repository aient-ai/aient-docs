...
description: "CloudEvent fired when Aient detects a new problem from grouped telemetry, with payload fields organisationId, problemId, environmentId, severity, and title."
---
