---
title: "integration.linear.disconnected"
description: "Webhook schema for ai.aient.integration.linear.disconnected"
---

# ai.aient.integration.linear.disconnected

> Generated from `@aient/events`. Do not edit this page by hand.

A Linear workspace connection became unusable.
...
| Schema ID | `sch_01KT52QVFFKAG4PG7Q9BYEW344` |
| Immutable schema | `https://registry.aient.ai/schemas/sch_01KT52QVFFKAG4PG7Q9BYEW344.json` |
| Version alias | `https://registry.aient.ai/events/ai.aient.integration.linear.disconnected/v1.json` |
...
```json
{
  ...
  "dataschema": "https://registry.aient.ai/schemas/sch_01KT52QVFFKAG4PG7Q9BYEW344.json",
  ...
  "type": "ai.aient.integration.linear.disconnected"
}
```
