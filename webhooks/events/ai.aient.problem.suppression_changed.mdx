---
title: "problem.suppression_changed"
description: "Webhook schema for ai.aient.problem.suppression_changed"
---

# ai.aient.problem.suppression_changed

> Generated from `@aient/events`. Do not edit this page by hand.

A problem alert suppression overlay changed.
...
| Schema ID | `sch_01KSGHAFQVD8J2J96VH1WG9R55` |
| Immutable schema | `https://registry.aient.ai/schemas/sch_01KSGHAFQVD8J2J96VH1WG9R55.json` |
| Version alias | `https://registry.aient.ai/events/ai.aient.problem.suppression_changed/v1.json` |
...
```json
{
  ...
  "dataschema": "https://registry.aient.ai/schemas/sch_01KSGHAFQVD8J2J96VH1WG9R55.json",
  ...
  "type": "ai.aient.problem.suppression_changed"
}
```
