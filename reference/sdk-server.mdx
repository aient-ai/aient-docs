---
title: "@aient/otel SDK reference"
description: "Configuration options for the @aient/otel Node.js package including publishable key, service name, release metadata, and exporter URL and header overrides."
---
