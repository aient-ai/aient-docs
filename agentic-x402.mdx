...
Use this path when the buyer is an agent or wallet principal. Use [Agent purchase and configuration](./agent-commerce) when a human or team is buying a normal SaaS subscription through Stripe.
