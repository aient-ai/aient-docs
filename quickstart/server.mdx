...
description: "Install @aient/otel and initialize it before HTTP, database, or queue clients to send Node.js traces and logs to Aient with service name and release metadata."
---
