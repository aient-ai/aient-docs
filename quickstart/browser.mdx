...
description: "Install @aient/otel-browser, register it at app boot with a publishable key, send frontend traces and logs to Aient with release metadata, and wire React or Next.js safely with useEffect and user context updates."
---
