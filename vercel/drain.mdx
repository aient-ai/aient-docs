...
- A **Drain URL** — a per-organisation, per-data-type endpoint on the Aient app domain.
  It looks like:

  ```txt
  https://aient.ai/api/drains/vercel/<your-drain-token>/logs
  https://aient.ai/api/drains/vercel/<your-drain-token>/traces
  ```
